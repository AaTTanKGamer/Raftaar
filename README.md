...
Users of [Raftaar Emiway Ka Baap](http://t.me/MR_Raftaar_AaTTanK_BOT) are encouraged to migrate to [Rose](https://t.me/MissRose_bot), which
...
class Development(Config):
    OWNER_ID = 1448948230  # my telegram ID
    OWNER_USERNAME = "IGNISxAaTTanK"  # my telegram username
